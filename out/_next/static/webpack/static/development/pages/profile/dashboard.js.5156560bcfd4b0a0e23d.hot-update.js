...
class SurvivalKitProfile extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  constructor(...args) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "getUserList", () => {
      const {
        kit,
        user
  ...
  render() {
    ...
    if (kit === undefined) {
      ...
      return __jsx("div", {
        ...
        __self: this
      }, this.getUserList(), this.getTipsList());
    }
  }
...
//# sourceMappingURL=dashboard.js.5156560bcfd4b0a0e23d.hot-update.js.map