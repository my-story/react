  ...
  constructor(...args) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(this, "addSubHeading", () => {
      ...
      if (object !== "") {
        this.setState({
          kit: _objectSpread({}, this.state.kit, {
            techniques: _objectSpread({}, this.state.kit.techniques.technique, {
              technique: newArray
            })
          })
        }); // console.log(object, this.state.kit.products)
  ...
  render() {
    ...
    if (this.state.kit) {
      return __jsx("div", {
        ...
        __self: this
      }, " Add subheading technique "), __jsx("button", {
...
//# sourceMappingURL=[id].js.9c575e366add8766cba7.hot-update.js.map